...
// udg_versusOff
//===========================================================================
const Trig_sheepWin_Func001Func003A = (): void => {
...
const Trig_sheepWin_Func001Func005A = (): void => {
  udg_sheepSurvived[GetConvertedPlayerId(GetEnumPlayer()!)] =
    udg_sheepSurvived[GetConvertedPlayerId(GetEnumPlayer()!)] +
    (I2S(CountPlayersInForceBJ(udg_Sheep)) + " | ");
  udg_wins[GetConvertedPlayerId(GetEnumPlayer()!)] =
    udg_wins[GetConvertedPlayerId(GetEnumPlayer()!)] + 1;
};

const Trig_sheepWin_Func001Func007C = (): boolean => {
...
const Trig_sheepWin_Func001C = (): boolean => {
...
const Trig_sheepWin_Func002Func001Func001C = (): boolean => {
  if ((!(udg_versus === 2))) {
    return false;
  }
  return true;
...
const Trig_sheepWin_Func002Func001C = (): boolean => {
  if ((!(udg_versus === 1))) {
    return false;
  }
  return true;
...
const Trig_sheepWin_Func002C = (): boolean => {
  if ((!(udg_Teams === 2))) {
    return false;
  }
  return true;
...
const Trig_sheepWin_Actions = (): void => {
  if ((Trig_sheepWin_Func001C())) {
    udg_atempgroup = GetUnitsOfTypeIdAll(FourCC("uC04"))!;
