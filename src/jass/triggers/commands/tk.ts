...
// Trigger: tk
//===========================================================================
const Trig_tk_Func003Func001Func001C = (): boolean => {
...
const Trig_tk_Func003Func001A = (): void => {
...
const Trig_tk_Func003Func002Func001C = (): boolean => {
  if (
...
const Trig_tk_Func003Func006Func001C = (): boolean => {
  if (
    (!(GetPlayerSlotState(ConvertedPlayer(GetForLoopIndexA())!) ===
      PLAYER_SLOT_STATE_PLAYING))
  ) {
...
const Trig_tk_Func003C = (): boolean => {
