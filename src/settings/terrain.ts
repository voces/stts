...
// Don't add optional props since we do Object.assign
export type Terrain = {
  index: number;
...
const initTrigger = () => {
  ...
  TriggerAddCondition(t, Condition(() => GetTriggerPlayer() === udg_Custom && !udg_gameStarted && !bulldog.enabled));
  TriggerAddAction(t, () => {
...
export const getCenter = () => ({
  x: GetRectCenterX(terrain.wolf),
  y: GetRectCenterY(terrain.wolf),
});
